...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ResponseAnimationBlendshapeDeltaEvent : ServerEvent
    {
        ...
        internal ResponseAnimationBlendshapeDeltaEvent(string responseId, string itemId, int outputIndex, int contentIndex, BinaryData frames, int frameIndex) : base(ServerEventType1.ResponseAnimationBlendshapesDelta)
        {
        ...
        /// <param name="frames"></param>
        /// <param name="frameIndex"></param>
        internal ResponseAnimationBlendshapeDeltaEvent(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, string itemId, int outputIndex, int contentIndex, BinaryData frames, int frameIndex) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
