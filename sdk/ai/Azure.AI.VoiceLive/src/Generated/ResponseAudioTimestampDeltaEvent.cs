...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ResponseAudioTimestampDeltaEvent : ServerEvent
    {
        ...
        internal ResponseAudioTimestampDeltaEvent(string responseId, string itemId, int outputIndex, int contentIndex, int audioOffsetMs, int audioDurationMs, string text) : base(ServerEventType1.ResponseAudioTimestampDelta)
        {
