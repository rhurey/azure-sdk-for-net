    ...
    public partial class ServerEventConversationItemInputAudioTranscriptionCompleted : IJsonModel<ServerEventConversationItemInputAudioTranscriptionCompleted>
    {
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServerEventConversationItemInputAudioTranscriptionCompleted)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override ServerEvent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServerEventConversationItemInputAudioTranscriptionCompleted)} does not support reading '{options.Format}' format.");
            }
        }
