...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ClientEventInputAudioTurnEnd : ClientEvent
    {
        ...
        public ClientEventInputAudioTurnEnd(string turnId) : base(ClientEventType1.InputAudioTurnEnd)
        {
        ...
        /// <param name="turnId"> The ID of the audio turn being ended. </param>
        internal ClientEventInputAudioTurnEnd(ClientEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string turnId) : base(@type, eventId, additionalBinaryDataProperties)
        {
            TurnId = turnId;
        }
