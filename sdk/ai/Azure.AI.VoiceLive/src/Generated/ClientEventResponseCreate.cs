...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ClientEventResponseCreate : ClientEvent
    {
        ...
        public ClientEventResponseCreate() : base(ClientEventType1.ResponseCreate)
        {
        }
        ...
        internal ClientEventResponseCreate(ClientEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResponseCreateParams response, string additionalInstructions) : base(@type, eventId, additionalBinaryDataProperties)
        {
            Response = response;
