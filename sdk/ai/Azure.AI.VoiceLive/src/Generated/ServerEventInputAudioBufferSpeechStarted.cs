...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventInputAudioBufferSpeechStarted : ServerEvent
    {
        ...
        internal ServerEventInputAudioBufferSpeechStarted(int audioStartMs, string itemId) : base(ServerEventType1.InputAudioBufferSpeechStarted)
        {
        ...
        /// </param>
        /// <param name="itemId"> The ID of the user message item that will be created when speech stops. </param>
        internal ServerEventInputAudioBufferSpeechStarted(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, int audioStartMs, string itemId) : base(@type, eventId, additionalBinaryDataProperties)
        {
            AudioStartMs = audioStartMs;
            ItemId = itemId;
        }
