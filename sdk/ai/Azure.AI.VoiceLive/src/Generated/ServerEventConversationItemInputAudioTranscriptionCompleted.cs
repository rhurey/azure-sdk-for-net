...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventConversationItemInputAudioTranscriptionCompleted : ServerEvent
    {
        ...
        internal ServerEventConversationItemInputAudioTranscriptionCompleted(string itemId, int contentIndex, string transcript) : base(ServerEventType1.ConversationItemInputAudioTranscriptionCompleted)
        {
            ItemId = itemId;
        ...
        /// <param name="contentIndex"> The index of the content part containing the audio. </param>
        /// <param name="transcript"> The transcribed text. </param>
        internal ServerEventConversationItemInputAudioTranscriptionCompleted(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string itemId, int contentIndex, string transcript) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ItemId = itemId;
            ContentIndex = contentIndex;
            Transcript = transcript;
