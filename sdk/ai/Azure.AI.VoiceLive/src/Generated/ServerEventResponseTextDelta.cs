...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseTextDelta : ServerEvent
    {
        ...
        internal ServerEventResponseTextDelta(string responseId, string itemId, int outputIndex, int contentIndex, string delta) : base(ServerEventType1.ResponseTextDelta)
        {
        ...
        /// <param name="contentIndex"> The index of the content part in the item's content array. </param>
        /// <param name="delta"> The text delta. </param>
        internal ServerEventResponseTextDelta(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, string itemId, int outputIndex, int contentIndex, string delta) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
