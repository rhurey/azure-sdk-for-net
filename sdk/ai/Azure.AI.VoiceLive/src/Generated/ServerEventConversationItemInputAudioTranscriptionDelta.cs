...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventConversationItemInputAudioTranscriptionDelta : ServerEvent
    {
        ...
        internal ServerEventConversationItemInputAudioTranscriptionDelta(string itemId) : base(ServerEventType1.ConversationItemInputAudioTranscriptionDelta)
        {
            ItemId = itemId;
        ...
        internal ServerEventConversationItemInputAudioTranscriptionDelta(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string itemId, int? contentIndex, string delta, IList<LogProbProperties> logprobs) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ItemId = itemId;
