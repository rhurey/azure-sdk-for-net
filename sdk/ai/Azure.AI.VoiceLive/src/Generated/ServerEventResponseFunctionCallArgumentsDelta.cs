...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseFunctionCallArgumentsDelta : ServerEvent
    {
        ...
        internal ServerEventResponseFunctionCallArgumentsDelta(string responseId, string itemId, int outputIndex, string callId, string delta) : base(ServerEventType1.ResponseFunctionCallArgumentsDelta)
        {
        ...
        /// <param name="callId"> The ID of the function call. </param>
        /// <param name="delta"> The arguments delta as a JSON string. </param>
        internal ServerEventResponseFunctionCallArgumentsDelta(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, string itemId, int outputIndex, string callId, string delta) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
