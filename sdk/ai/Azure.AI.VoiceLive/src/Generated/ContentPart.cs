...
namespace Azure.AI.VoiceLive
{
    ...
    public abstract partial class ContentPart
    {
        ...
        private protected ContentPart(ContentPartType1 @type)
        {
            Type = @type;
        }
        ...
        internal ContentPart(ContentPartType1 @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
        ...
        internal ContentPartType1 Type { get; set; }
    }
}
