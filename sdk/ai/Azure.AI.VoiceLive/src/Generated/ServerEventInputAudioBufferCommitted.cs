...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventInputAudioBufferCommitted : ServerEvent
    {
        ...
        internal ServerEventInputAudioBufferCommitted(string itemId) : base(ServerEventType1.InputAudioBufferCommitted)
        {
            ItemId = itemId;
        }
        ...
        /// <param name="itemId"> The ID of the user message item that will be created. </param>
        internal ServerEventInputAudioBufferCommitted(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string previousItemId, string itemId) : base(@type, eventId, additionalBinaryDataProperties)
        {
