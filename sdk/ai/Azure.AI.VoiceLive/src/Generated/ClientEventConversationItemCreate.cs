...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ClientEventConversationItemCreate : ClientEvent
    {
        ...
        public ClientEventConversationItemCreate() : base(ClientEventType1.ConversationItemCreate)
        {
        }
        ...
        internal ClientEventConversationItemCreate(ClientEventType1 @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string eventId, string previousItemId, ConversationItemWithReference item) : base(@type, eventId, additionalBinaryDataProperties)
        {
