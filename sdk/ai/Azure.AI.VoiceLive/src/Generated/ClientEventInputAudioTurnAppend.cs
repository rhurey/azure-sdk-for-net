...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ClientEventInputAudioTurnAppend : ClientEvent
    {
        ...
        public ClientEventInputAudioTurnAppend(string turnId, string audio) : base(ClientEventType1.InputAudioTurnAppend)
        {
        ...
        /// <param name="turnId"> The ID of the turn this audio is part of. </param>
        /// <param name="audio"> Base64-encoded audio chunk. </param>
        internal ClientEventInputAudioTurnAppend(ClientEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string turnId, string audio) : base(@type, eventId, additionalBinaryDataProperties)
        {
            TurnId = turnId;
            Audio = audio;
        }
