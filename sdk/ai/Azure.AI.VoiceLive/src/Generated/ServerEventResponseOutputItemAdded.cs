...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseOutputItemAdded : ServerEvent
    {
        ...
        internal ServerEventResponseOutputItemAdded(string responseId, int outputIndex) : base(ServerEventType1.ResponseOutputItemAdded)
        {
        ...
        internal ServerEventResponseOutputItemAdded(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, int outputIndex, ConversationItemWithReference item) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            OutputIndex = outputIndex;
            Item = item;
