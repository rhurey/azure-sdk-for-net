...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ClientEventConversationItemTruncate : ClientEvent
    {
        ...
        public ClientEventConversationItemTruncate(string itemId, int contentIndex, int audioEndMs) : base(ClientEventType1.ConversationItemTruncate)
        {
        ...
        /// will respond with an error.
        /// </param>
        internal ClientEventConversationItemTruncate(ClientEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string itemId, int contentIndex, int audioEndMs) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ItemId = itemId;
            ContentIndex = contentIndex;
            AudioEndMs = audioEndMs;
