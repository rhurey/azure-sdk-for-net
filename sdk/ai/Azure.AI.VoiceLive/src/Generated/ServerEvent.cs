...
namespace Azure.AI.VoiceLive
{
    ...
    public abstract partial class ServerEvent
    {
        ...
        private protected ServerEvent(ServerEventType1 @type)
        {
            Type = @type;
        }
        ...
        internal ServerEvent(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            EventId = eventId;
        ...
        internal ServerEventType1 Type { get; set; }
