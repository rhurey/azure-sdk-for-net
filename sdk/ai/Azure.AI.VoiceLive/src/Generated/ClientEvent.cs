...
namespace Azure.AI.VoiceLive
{
    ...
    public abstract partial class ClientEvent
    {
        ...
        private protected ClientEvent(ClientEventType1 @type)
        {
            Type = @type;
        }
        ...
        internal ClientEvent(ClientEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            EventId = eventId;
        ...
        internal ClientEventType1 Type { get; set; }
