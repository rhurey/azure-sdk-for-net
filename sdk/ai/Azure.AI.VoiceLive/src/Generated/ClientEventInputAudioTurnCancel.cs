...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ClientEventInputAudioTurnCancel : ClientEvent
    {
        ...
        public ClientEventInputAudioTurnCancel(string turnId) : base(ClientEventType1.InputAudioTurnCancel)
        {
        ...
        /// <param name="turnId"> The ID of the turn to cancel. </param>
        internal ClientEventInputAudioTurnCancel(ClientEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string turnId) : base(@type, eventId, additionalBinaryDataProperties)
        {
            TurnId = turnId;
        }
