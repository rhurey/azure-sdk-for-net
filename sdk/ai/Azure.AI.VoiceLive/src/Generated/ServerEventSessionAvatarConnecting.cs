...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventSessionAvatarConnecting : ServerEvent
    {
        ...
        internal ServerEventSessionAvatarConnecting(string serverSdp) : base(ServerEventType1.SessionAvatarConnecting)
        {
            ServerSdp = serverSdp;
        }
        ...
        /// <param name="serverSdp"> The server's SDP answer for the avatar connection. </param>
        internal ServerEventSessionAvatarConnecting(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string serverSdp) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ServerSdp = serverSdp;
        }
