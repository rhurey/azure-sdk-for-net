...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ClientEventInputAudioTurnStart : ClientEvent
    {
        ...
        public ClientEventInputAudioTurnStart(string turnId) : base(ClientEventType1.InputAudioTurnStart)
        {
        ...
        /// <param name="turnId"> Unique identifier for the input audio turn. </param>
        internal ClientEventInputAudioTurnStart(ClientEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string turnId) : base(@type, eventId, additionalBinaryDataProperties)
        {
            TurnId = turnId;
        }
