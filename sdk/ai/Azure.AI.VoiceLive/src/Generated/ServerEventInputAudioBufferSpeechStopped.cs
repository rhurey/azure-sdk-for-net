...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventInputAudioBufferSpeechStopped : ServerEvent
    {
        ...
        internal ServerEventInputAudioBufferSpeechStopped(int audioEndMs, string itemId) : base(ServerEventType1.InputAudioBufferSpeechStopped)
        {
        ...
        /// </param>
        /// <param name="itemId"> The ID of the user message item that will be created. </param>
        internal ServerEventInputAudioBufferSpeechStopped(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, int audioEndMs, string itemId) : base(@type, eventId, additionalBinaryDataProperties)
        {
            AudioEndMs = audioEndMs;
            ItemId = itemId;
        }
