...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ResponseAnimationVisemeDeltaEvent : ServerEvent
    {
        ...
        internal ResponseAnimationVisemeDeltaEvent(string responseId, string itemId, int outputIndex, int contentIndex, int audioOffsetMs, int visemeId) : base(ServerEventType1.ResponseAnimationVisemeDelta)
        {
        ...
        /// <param name="audioOffsetMs"></param>
        /// <param name="visemeId"></param>
        internal ResponseAnimationVisemeDeltaEvent(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, string itemId, int outputIndex, int contentIndex, int audioOffsetMs, int visemeId) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
