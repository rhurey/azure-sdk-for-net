...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseTextDone : ServerEvent
    {
        ...
        internal ServerEventResponseTextDone(string responseId, string itemId, int outputIndex, int contentIndex, string text) : base(ServerEventType1.ResponseTextDone)
        {
        ...
        /// <param name="contentIndex"> The index of the content part in the item's content array. </param>
        /// <param name="text"> The final text content. </param>
        internal ServerEventResponseTextDone(ServerEventType1 @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, string itemId, int outputIndex, int contentIndex, string text) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
