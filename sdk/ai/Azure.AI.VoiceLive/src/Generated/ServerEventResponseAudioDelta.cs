...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseAudioDelta : ServerEvent
    {
        ...
        internal ServerEventResponseAudioDelta(string responseId, string itemId, int outputIndex, int contentIndex, BinaryData delta) : base(ServerEventType1.ResponseAudioDelta)
        {
        ...
        internal ServerEventResponseAudioDelta(ServerEventType1 @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, string itemId, int outputIndex, int contentIndex, BinaryData delta, string eventId) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
